...
3. **Negative sampling vectorizado** — v2 iteraba cada sample en Python (`for target_idx in train_context: np.random.choice(...)`), lo cual es inviable con millones de pares. v3 usa:
